// src/pages/Citas/RegistroCitasGraficos.jsx
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
                ...
                <ChartCard title="Distribución por estado" subtitle="Rendimiento de casos">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            <Tooltip content={<CustomTooltip />} />
                            <Legend />
                            <Pie data={byStatus} dataKey="value" nameKey="name" innerRadius={62} outerRadius={90} paddingAngle={2}>
                                {byStatus.map((_, idx) => (
            ...
            <div className="grid gap-4 lg:grid-cols-3">
                <div className="lg:col-span-2">
                    <ChartCard title="Casos por categoría" subtitle="Enfoca el esfuerzo donde más duele">
                        <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-slate-600">Cambios, asignaciones y evidencia.</p>
